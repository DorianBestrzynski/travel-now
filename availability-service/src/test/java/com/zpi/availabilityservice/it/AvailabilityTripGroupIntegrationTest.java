...
public class AvailabilityTripGroupIntegrationTest {
    ...
    @Test
    void shouldReturnCorrectAvailabilityConstraint() {
        Long groupId = 1L;
        String suffix = "availability-info";
        ...
        assertThat(response).satisfies(
                res -> {
                    ...
                    assertThat(res.getBody()).satisfies(
                            ac -> {
                                assertThat(ac.numberOfDays()).isEqualTo(3);
                                assertThat(ac.numberOfParticipants()).isEqualTo(4);
                            }
                    );
                    assertThat(Objects.requireNonNull(res.getHeaders().get("Content-Type")).get(0)).isEqualTo("application/json");
                }
    ...
    @Test
    void shouldReturnNotFoundWhenThereIsNoGroupWithGivenGroupId() {
        Long groupId = 12L;
        String suffix = "availability-info";
        ...
        assertThat(exception.getStatusCode().name()).isEqualTo("NOT_FOUND");
    }

    private ResponseEntity<AvailabilityConstraintsDto> callTripGroupGetEndpoints(Long groupId, String suffix) {
        ...
        return restTemplate.exchange(
                ...
                HttpMethod.GET,
                entity,
                AvailabilityConstraintsDto.class
        );
    }
